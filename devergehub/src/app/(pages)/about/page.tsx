...
function SectionLabel({ children, dark = true }: { children: ReactNode; dark?: boolean }) {
  return (
    ...
    >
      <span className={`h-px w-10 ${dark ? "bg-emerald-500/70" : "bg-emerald-600/60"}`} />
      <span>{children}</span>
    </div>
  );
}
...
<p className="mt-6 max-w-2xl mx-auto lg:mx-0 text-[16px] md:text-[20px] leading-7 md:leading-[1.4] text-white/80 font-normal">    De Verge Hub is a software development company focused on designing and
    ...
    stand out, and succeed in today&apos;s digital world.
            ...
            <div className="mx-auto w-full max-w-[24rem] rounded-[2rem] border border-white/10 bg-white/5 p-4 shadow-[0_20px_70px_rgba(0,0,0,0.24)] backdrop-blur-sm">
              <div className="grid gap-3 sm:grid-cols-2">
                ...
                <div className="rounded-2xl border border-emerald-500/10 bg-[#13253d]/90 p-4">
                  ...
                  <h3 className="mt-2 text-[1.85rem] font-medium text-white">Web</h3>
                  <p className="mt-2 text-sm leading-6 text-white/58">
      ...
      <section id="about" className="bg-[#071115] px-6 py-8 md:px-10 lg:px-12 lg:py-16">
        <div className="mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1fr_1.02fr]">
          ...
          <div>
            ...
            <p className="mt-5font-medium text-[11.58px] leading-[15.06px] tracking-normal md:text-sm md:leading-6">
              ...
              digital products, transformative web and mobile experiences, and expert
              consulting services that help businesses thrive in the digital age.
            </p>
            <p className="mt-5 font-medium text-[11.58px] leading-[15.06px] tracking-normal md:text-sm md:leading-6">
              We focus on understanding our clients&apos; needs, creating tailored
              solutions, and providing ongoing support to ensure their continued
              success.
            </p>
          ...
          <div className="mt-10 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {values.map((value) => (
              ...
              >
                ...
                <p className="mt-4 text-sm leading-7 text-white/70">{value.description}</p>
              </article>
            ))}
          </div>
        </div>
  ...
  {achievements.map((item) => (
   <article
  key={item.title}
  className={`relative min-h-[16rem] overflow-hidden rounded-[1.3rem] ${item.accent} p-8 text-white shadow-[0_18px_40px_rgba(0,0,0,0.18)] group`}
>
  ...
  <div className="relative z-10 flex h-full flex-col justify-end">
    ...
    <p className="mt-3 max-w-xl text-sm leading-6 text-white/90">
      ...
      <section className="bg-[#071115] px-6 py-16 md:px-10 lg:px-12 lg:py-20">
        <div className="mx-auto w-full max-w-[1346px]">
          <p className="text-2xl font-semibold text-emerald-400">Meet Our Team</p>
