...
export default function BlogPage() {
  ...
  return (
    <main className={`${montserrat.className} min-h-screen bg-[#081216] text-white`}>
      ...
      <footer className="bg-[#11131d] px-6 pb-8 pt-16 text-white md:px-10 lg:px-12">
        <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-[1.35fr_0.8fr_0.7fr_1fr]">
          <div>
            <BrandMark />
          ...
          <div>
            ...
            <ul className="mt-5 space-y-3 text-[1.9rem] leading-tight text-white/95 md:text-[1.55rem]">
          ...
          <div>
            ...
            <form className="mt-5 space-y-3">
              <input
                ...
                className="w-full rounded-md border border-white/35 bg-white/5 px-4 py-3 text-base text-white outline-none placeholder:text-white/45 focus:border-emerald-500"
              />
              <button
                type="submit"
